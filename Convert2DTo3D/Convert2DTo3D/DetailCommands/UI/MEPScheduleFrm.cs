...
{
    public partial class MEPScheduleFrm : System.Windows.Forms.Form
    {
        ...
        private List<Parameter> GetParamters()
        {
            try
            {
                ...
                if (SelectedType == 0)
                {
                    elem = new FilteredElementCollector(Global.Doc)
                        .OfCategory(BuiltInCategory.OST_PipeCurves)
                        .OfClass(typeof(Pipe))
                        .FirstOrDefault() as Pipe;
                }
        ...
        {
            List<string> fields = new List<string>() { "HeaderSchedule", "DonVi", "LoaiMEP" };
    ...
    {
        public Parameter Field { get; set; }

        public string Name { get; set; }

        public FieldData(Parameter field)
        {
            if (field != null)
            {
                Field = field;
